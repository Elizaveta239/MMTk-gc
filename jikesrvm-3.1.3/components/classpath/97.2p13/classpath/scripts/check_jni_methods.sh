...
grep -h '^JNIEXPORT .* Java_' /home/elizabeth/sum13/ideal/jikesrvm-3.1.3/components/classpath/97.2p13/classpath/include/*.h | \
...
find /home/elizabeth/sum13/ideal/jikesrvm-3.1.3/components/classpath/97.2p13/classpath/native/jni -name \*.c | \
	xargs grep -h '^Java_' | \
...
find /home/elizabeth/sum13/ideal/jikesrvm-3.1.3/components/classpath/97.2p13/classpath/native/jni -name \*.cpp | \
	xargs grep -h '^Java_' | \
        LC_ALL=C sed -e 's,^\(Java_[a-z_A-Z0-9]*\).*$,\1,' >> $TMPFILE2
find /home/elizabeth/sum13/ideal/jikesrvm-3.1.3/components/classpath/97.2p13/classpath/native/jni -name \*.cpp | \
